<section id="newscard_horizontal_vertical_posts-7" class="widget newscard-widget-horizontal-vertical-posts">
    @foreach($cinema as $category)
            ...
            <div class="post-boxed main-post clearfix">
                ...
                <div class="post-content">
                    ...
                    <div class="entry-meta">
                        ...
                        <div class="by-author vcard author"><a href="{{ route('user.page', ['id'=>$post->user->id]) }}">
                            {{ $post->user->name }}
                        </a></div>
                    </div>
